...
- ชื่อ-นามสกุล: Suwimon Chaidath
- รหัสนักศึกษา: 68543210046-7
- ระบบปฏิบัติการที่ใช้: macOS / linuxMint
- URL: https://github.com/Mssuwimon/engse203-lab03-68543210046-7
...
![หน้าเว็บเริ่มต้น](./screenshots/หน้าเว็บ.png)
...
![ระบบแจ้งเตือนข้อผิดพลาด](./screenshots/แจ้งเตือน.png)
...
![การแสดงผลแบบเรียลไทม์](./screenshots/กรอกข้อมูล.png)
...
![การแสดงรายการคำขอ](./screenshots/แสดงRequest.png)
...
![การอัปเดตจำนวนและสถานะ](./screenshots/แสดงจำนวนRequest.png)
