...
function RequestDetailPage() {
  ...
  useEffect(() => { //Bug #4 แก้ไขการโหลดรายละเอียดคำร้องโดยใช้ useEffect และ reloadKey เพื่อให้สามารถโหลดข้อมูลใหม่ได้เมื่อกดปุ่ม reload
    let ignore = false;
    ...
    return () => { ignore = true; };
  }, [requestId, reloadKey]); //Bug #4 แก้ไขการโหลดรายละเอียดคำร้องโดยใช้ useEffect และ reloadKey เพื่อให้สามารถโหลดข้อมูลใหม่ได้เมื่อกดปุ่ม reload
...
////สาเหตุ: requestId ไม่ได้อยู่ใน dependency array ทำให้เมื่อ URL เปลี่ยน Effect ไม่ทำงานใหม่และแสดงข้อมูลเดิม